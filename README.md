...
## Sobre este proyecto
[2–3 frases: qué es FinTrack, qué problema resuelve esta evaluación, y qué
encontrará quien lea el repositorio. Escríbelo cuando termines la Sesión 1.]
...
## Tesis
[Una frase que resuma el hallazgo central de tu evaluación. La construirás
a lo largo del curso. Pista de la Sesión 3: el perímetro de FinTrack no es
